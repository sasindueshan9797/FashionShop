...
public class DeleteOrder extends javax.swing.JFrame {
    ...
    public DeleteOrder() {
        ...
        deleleButton = new JButton("Delete");
        deleleButton.setPreferredSize(new Dimension(100, 30));
        deleleButton.setBackground(new Color(214, 48, 49));
        deleleButton.setForeground(Color.white);
        deleleButton.setFont(new Font("Segoe UI", 1, 15));
        deleleButton.setOpaque(true);
        deleleButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (choice == JOptionPane.YES_OPTION) {
                    ...
                    if (index >= 0) {
                        ...
                        OrderController.removeItems(index);
